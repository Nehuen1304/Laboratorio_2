...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	2fe58593          	addi	a1,a1,766 # 1310 <malloc+0x100>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2c058593          	addi	a1,a1,704 # 1320 <malloc+0x110>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	28e50513          	addi	a0,a0,654 # 1328 <malloc+0x118>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	36270713          	addi	a4,a4,866 # 1428 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      e6:	24e50513          	addi	a0,a0,590 # 1330 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	23458593          	addi	a1,a1,564 # 1338 <malloc+0x128>
     10c:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     154:	1f858593          	addi	a1,a1,504 # 1348 <malloc+0x138>
     158:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1ea:	17250513          	addi	a0,a0,370 # 1358 <malloc+0x148>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dcca8a93          	addi	s5,s5,-564 # 1380 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	d9a50513          	addi	a0,a0,-614 # 1360 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cea60613          	addi	a2,a2,-790 # 1388 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	cceb0b13          	addi	s6,s6,-818 # 13a8 <malloc+0x198>
  ...
  return ret;
     ...
     70c:	c8850513          	addi	a0,a0,-888 # 1390 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c2e50513          	addi	a0,a0,-978 # 1398 <malloc+0x188>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c0060613          	addi	a2,a2,-1024 # 13b0 <malloc+0x1a0>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	b98a0a13          	addi	s4,s4,-1128 # 13b8 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	b6a60613          	addi	a2,a2,-1174 # 13c0 <malloc+0x1b0>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	acc60613          	addi	a2,a2,-1332 # 1388 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	aec60613          	addi	a2,a2,-1300 # 13d8 <malloc+0x1c8>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     932:	a9a50513          	addi	a0,a0,-1382 # 13c8 <malloc+0x1b8>
     936:	fffff097          	auipc	ra,0xfffff
     93a:	720080e7          	jalr	1824(ra) # 56 <panic>
    panic("syntax - missing )");
     93e:	00001517          	auipc	a0,0x1
     942:	aa250513          	addi	a0,a0,-1374 # 13e0 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	ad670713          	addi	a4,a4,-1322 # 1440 <malloc+0x230>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	90260613          	addi	a2,a2,-1790 # 1318 <malloc+0x108>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	9ac58593          	addi	a1,a1,-1620 # 13f8 <malloc+0x1e8>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	6d4080e7          	jalr	1748(ra) # 112a <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	93250513          	addi	a0,a0,-1742 # 1390 <malloc+0x180>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	98a48493          	addi	s1,s1,-1654 # 1408 <malloc+0x1f8>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	8dc58593          	addi	a1,a1,-1828 # 1410 <malloc+0x200>
     b3c:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fc6:	f9d9079b          	addiw	a5,s2,-99
     fca:	0ff7f713          	zext.b	a4,a5
     fce:	12eb6163          	bltu	s6,a4,10f0 <vprintf+0x192>
     fd2:	00271793          	slli	a5,a4,0x2
     fd6:	00000717          	auipc	a4,0x0
     fda:	48270713          	addi	a4,a4,1154 # 1458 <malloc+0x248>
  ...
  putc(fd, 'x');
    ...
    1066:	44eb8b93          	addi	s7,s7,1102 # 14b0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10bc:	36890913          	addi	s2,s2,872 # 1420 <malloc+0x210>
        while(*s != 0){
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    1194:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1198:	00001797          	auipc	a5,0x1
    119c:	6487b783          	ld	a5,1608(a5) # 27e0 <freep>
    ...
    11c4:	00e6ea63          	bltu	a3,a4,11d8 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11de:	02059813          	slli	a6,a1,0x20
    11e2:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    11f2:	02061593          	slli	a1,a2,0x20
    11f6:	01c5d713          	srli	a4,a1,0x1c
  ...
  freep = p;
    ...
    1206:	5cf73f23          	sd	a5,1502(a4) # 27e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1230:	5b453503          	ld	a0,1460(a0) # 27e0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1260:	58490913          	addi	s2,s2,1412 # 27e0 <freep>
  if(p == (char*)-1)
    1264:	5afd                	li	s5,-1
    ...
    1274:	5e878793          	addi	a5,a5,1512 # 2858 <base>
    1278:	00001717          	auipc	a4,0x1
    127c:	56f73423          	sd	a5,1384(a4) # 27e0 <freep>
  ...
  if(p == (char*)-1)
    ...
    12f2:	4ea73923          	sd	a0,1266(a4) # 27e0 <freep>
      return (void*)(p + 1);
