...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fa4:	00005797          	auipc	a5,0x5
    5fa8:	82c7b783          	ld	a5,-2004(a5) # a7d0 <freep>
    ...
    5fd0:	00e6ea63          	bltu	a3,a4,5fe4 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    600e:	00004717          	auipc	a4,0x4
    6012:	7cf73123          	sd	a5,1986(a4) # a7d0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    6038:	00004517          	auipc	a0,0x4
    603c:	79853503          	ld	a0,1944(a0) # a7d0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    6068:	00004917          	auipc	s2,0x4
    606c:	76890913          	addi	s2,s2,1896 # a7d0 <freep>
  if(p == (char*)-1)
    6070:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    607c:	0000b797          	auipc	a5,0xb
    6080:	f7c78793          	addi	a5,a5,-132 # 10ff8 <base>
    6084:	00004717          	auipc	a4,0x4
    6088:	74f73623          	sd	a5,1868(a4) # a7d0 <freep>
  ...
  if(p == (char*)-1)
    ...
    60f6:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    60fa:	00004717          	auipc	a4,0x4
    60fe:	6ca73b23          	sd	a0,1750(a4) # a7d0 <freep>
      return (void*)(p + 1);
